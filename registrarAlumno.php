...
<html>
  ...
  <body>
    ...
    <div class="container border-right border-left">
	  ...
	  <center>
		<h2 class="main-text mt-3">Registrar nuevo alumno</h2>
      </center>
        ...
        <div class="row mx-auto mb-5 mt-1" >
          ...
          <div class="col-9 mx-auto border">
		   ...
		   <form class="form mt-3" action="registrarInfo.php" method="post">
		     <h5>Código</h5>
			  <input type="text" class="form-control form-control-lg mb-3" name="codigo" required="required" pattern="[0-9]{1,9}"
				placeholder="Código">
			  ...
			  <select class="form-control form-control-lg mb-3" name="maestria" required="required">
				<option value="" disabled selected>Maestría</option>
				<?php
			  ...
			  <div class="row">
				...
				<div class="col">
				  <h5>Ciclo ingreso</h5>
				  <select class="form-control form-control-lg mb-3" name="cicloIngreso" required="required">
				    <option value="" disabled selected>Ciclo ingreso</option>
					<?php
						$fecha = date("Y-m-d");
			  ...
			  <input class="btn degradado-gris text-secondary my-3" type="submit" name="rAlumno" value="Guardar">
