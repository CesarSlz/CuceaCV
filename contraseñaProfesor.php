          ...
          <div class="col-12 border">
		   ...
		   <form class="form mt-3" action="cambiarContraseña.php" method="post">
			...
			<?php
				...
				echo'<input class="btn degradado-gris text-secondary my-3" type="submit" name="cambiarContraProfesor" value="Cambiar contraseña">';
				echo '<a class="btn degradado-gris text-secondary my-3 ml-2 float-right" href="perfilProfesor.php">Regresar</a>';
			?>
